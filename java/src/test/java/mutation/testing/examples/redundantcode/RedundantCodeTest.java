...
public class RedundantCodeTest {
    ...
    public void onlyOneWord() throws Exception {
        String result = underTest
                .findWordThatComesAlphabeticallyFirst(new WordList("word"));
    ...
    public void twoWordAlreadyInTheRightOrder() throws Exception {
        String result = underTest
                .findWordThatComesAlphabeticallyFirst(new WordList("abc", "bcd"));
        assertThat(result, is("abc"));
    }

    @Test
    public void threeWordsInRandomOrder() throws Exception {
        String result = underTest.findWordThatComesAlphabeticallyFirst(
                new WordList("zoo", "albatross", "bird"));
